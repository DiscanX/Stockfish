...
const Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Bishop
   ...
   { S(-45,-36), S(-6, -37), S(-13,-39), S(-24,-17) },
   { S(-45,-60), S(-10,-38), S(-18,-41), S(-25,-21) },
   { S(-51,-59), S(-18,-37), S(-22,-34), S(-32,-23) },
   { S(-57,-68), S(-17,-45), S(-28,-46), S(-36,-28) },
   { S(-69,-89), S(-45,-66), S(-53,-70), S(-63,-51) }
  },
  { // Rook

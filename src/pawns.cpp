...
namespace {
  ...
  Score evaluate(const Position& pos, Pawns::Entry* e) {
    ...
    Bitboard filesWithoutEdges = ~(FileABB | FileHBB);

    e->passedPawns[Us]   = e->pawnAttacksSpan[Us] = 0;
    e->semiopenFiles[Us] = 0xFF;
    e->kingSquares[Us]   = SQ_NONE;
    e->pawnAttacks[Us]   = shift<Right>(ourPawns) | shift<Left>(ourPawns);
    e->pawnsOnSquaresExceptSides[Us][BLACK] = popcount((ourPawns & DarkSquares & filesWithoutEdges));
    e->pawnsOnSquaresExceptSides[Us][WHITE] = popcount((ourPawns & LightSquares & filesWithoutEdges));

  ...
  Score evaluate_pieces(const Position& pos, EvalInfo& ei, Score* mobility) {
    ...
    while ((s = *pl++) != SQ_NONE)
    {
        ...
        if (Pt == BISHOP || Pt == KNIGHT)
        {
            ...
            // Penalty for pawns on the same color square as the bishop/knight
            score -= (Pt == BISHOP ? BishopPawns : KnightPawns) * ei.pe->pawns_on_same_color_squares(Us, s);
